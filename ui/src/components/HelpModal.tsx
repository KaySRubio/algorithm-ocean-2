...
const HelpModal = ({
  ...
  // TODO - update so it can also check insertionDirections if insertion
  // TODO - unclear if type of sort is a prop or in context?
  ...
  useEffect(() => {
    document.getElementById('helpModal')?.focus(); // TODO - replace with ref
  }, [])
